...
public class CitaController {
    ...
    public ResponseEntity<?> getCitasByMedico(@PathVariable Integer idMedico) {
        ...
        if (medico.getEspecialidad() != null) {
            medicoMap.put("especialidad", mapEspecialidad(medico));
            medicoMap.put("especialidadNombre", medico.getEspecialidad().getNombre());
        } else {
            medicoMap.put("especialidad", null);
            medicoMap.put("especialidadNombre", "No registrado");
        }
    ...
    private Map<String, Object> mapCitaToSimpleMap(Cita cita) {
        ...
        if (cita.getPaciente() != null) {
            map.put("paciente", mapPaciente(cita.getPaciente()));
        }

        if (cita.getMedico() != null) {
            map.put("medico", mapMedico(cita.getMedico()));

            if (cita.getMedico().getEspecialidad() != null) {
                map.put("especialidad", cita.getMedico().getEspecialidad().getNombre());
                map.put("especialidadNombre", cita.getMedico().getEspecialidad().getNombre());
            } else {
                map.put("especialidad", "No registrado");
                map.put("especialidadNombre", "No registrado");
            }
        }
    ...
    private Map<String, Object> mapMedico(Medico medico) {
        Map<String, Object> medicoMap = new HashMap<>();
    ...
    private Map<String, Object> mapEspecialidad(Medico medico) {
        ...
        especialidadMap.put("descripcion", medico.getEspecialidad().getDescripcion());

...
public class UsuarioController {
    ...
    private Map<String, Object> mapUsuarioToSimpleMap(Usuario usuario) {
        ...
        map.put("usuario", obtenerUsuarioLogin(usuario.getIdUsuario()));
    ...
    private String obtenerUsuarioLogin(Integer idUsuario) {
        try {
            String sql = "SELECT usuario FROM logeo WHERE id_usuario = ?";
